updated: 2026-07-15
status: canonical cross-cutting design law
...
`*.style.ts` modules execute as ordinary TypeScript at build time. They are not restricted to expressions a static analyzer can reconstruct. Loops, imports, plugin functions, generated maps, and composition remain ordinary language behavior.
...
const manifestToken = {
  ...
  declarations: [
    ...
    { kind: 'axis', axis: 'scheme', mode: 'dark', val: '...', context: {/* ... */} },
  ],
}
```
