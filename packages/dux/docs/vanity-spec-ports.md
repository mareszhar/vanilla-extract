...
The runtime-boundary law lives in [vanity-patterns.md §4](./vanity-patterns.md#4-the-runtime-boundary-is-a-port), and explicit ownership lives in [vanity-patterns.md §9](./vanity-patterns.md#9-runtime-ownership-is-explicit). This document owns port declaration, serialization, validation, publication, and SSR behavior.
