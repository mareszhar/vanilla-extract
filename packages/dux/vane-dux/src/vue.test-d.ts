...
describe('usePorts', () => {
  it('binds fragments or a thunk to a computed style object', () => {
    expectTypeOf(usePorts(fraction.set(0.5))).toEqualTypeOf<ComputedRef<CSSProperties>>()
    expectTypeOf(usePorts(() => [fraction.set(0.5)])).toEqualTypeOf<ComputedRef<CSSProperties>>()
  })
...
describe('useAnatomy', () => {
  ...
  it('literals stay strict; widened props flow through', () => {
    ...
    const props = {} as VaneProps<typeof dialog> & { disabled?: boolean }
