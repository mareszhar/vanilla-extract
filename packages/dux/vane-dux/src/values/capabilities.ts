/** Machine-readable Phase-1 capability declarations for same-named CSS helpers. */

import type { VaneCssFeature } from './protocol'

export type VaneHelperMaturity = 'stable' | 'experimental'

export interface VaneCssHelperCapability {
  readonly css: string
  readonly accepted: readonly string[]
  readonly shorthand: readonly string[]
  readonly output: string
  readonly fold: 'proven' | 'preserve-native' | 'fallback-plus-enhancement'
  readonly maturity: VaneHelperMaturity
  readonly requirements: readonly VaneCssFeature[]
  readonly rawLane: string
}

function capability(value: VaneCssHelperCapability): VaneCssHelperCapability {
...
export const VANE_CSS_CAPABILITIES = Object.freeze({
  calc: capability({
    css: 'calc()',
...
} satisfies Record<string, VaneCssHelperCapability>)
 ...
 */
export const VANE_HELPER_MATURITY_POLICY = Object.freeze({
