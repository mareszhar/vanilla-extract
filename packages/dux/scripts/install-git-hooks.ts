 ...
 *   workspace, so the outer repo's hooks cannot validate Vanity.
 * - Git has one `core.hooksPath` per worktree. Installing the Vanity hook there
 *   lets the hook inspect staged paths and no-op unless a commit touches Vanity.
