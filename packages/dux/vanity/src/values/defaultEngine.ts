/** The configured internal engine shared by core constructors and characterization helpers. */

import type { VanityAuthoredColor, VanityAuthoredInterpolatedColor, VanityColor, VanityInterpolatedColor } from '../tokens/types'
...
export interface VanityCoreConstructors<DefaultLengthUnit extends VanityLengthUnit = 'px'>
...
type VanityCanonicalResult<Result>
  = Result extends VanityInterpolatedColor<any> ? VanityAuthoredInterpolatedColor
    : Result extends VanityColor<any> ? VanityAuthoredColor
      : Result
...
export type VanityCanonicalCoreConstructors<DefaultLengthUnit extends VanityLengthUnit = 'px'>
  = Omit<VanityCoreConstructors<DefaultLengthUnit>, VanityColorConstructorName> & {
    readonly [Key in VanityColorConstructorName]: VanityCanonicalConstructor<VanityCoreConstructors<DefaultLengthUnit>[Key]>
  }
...
): VanityCoreConstructors<DefaultLengthUnit> {
