...
import type { VanityCssFunction, VanityPropertyAliasCssFunction, VanityPropertyAliasMap, VanityStrictPropertyAliasCssFunction } from '../css/types'
import type { VanityEngineKernel } from '../internal/engineKernel'
import type { VanityDtcgCodec } from '../internal/interchange'
import type { VanityPropertyAliasContribution, VanityPropertyAliasPlugin } from '../plugins/propertyAliases'
import type {
...
import type { VanityCanonicalCoreConstructors } from '../values/defaultEngine'
...
export interface VanityEnginePlugin<
  ...
  RequiredConstructors extends object = VanityCanonicalCoreConstructors<VanityLengthUnit>,
...
> extends VanityEngineCommonMethods<TokenPolicy, Axes> {
  ...
  readonly use: {
    <const AddedAliases extends VanityPropertyAliasMap>(
      plugin: VanityPropertyAliasPlugin<AddedAliases, 'both'>,
    ): VanityAliasedEngine<Constructors & VanityPropertyAliasContribution<AddedAliases, 'both'>, TokenPolicy, Axes, AddedAliases>
    <const AddedAliases extends VanityPropertyAliasMap>(
      plugin: VanityPropertyAliasPlugin<AddedAliases, 'aliases-only'>,
    ): VanityStrictAliasedEngine<Constructors & VanityPropertyAliasContribution<AddedAliases, 'aliases-only'>, TokenPolicy, Axes, AddedAliases>
...
export interface VanityAliasedEngineMethods<
  Constructors extends object,
  TokenPolicy extends VanityTokenPolicy,
...
> extends VanityEngineCommonMethods<TokenPolicy, Axes> {
  ...
  >(
    options: VanityEngineSystemOptions<T, C, L, P, B, TokenPolicy>,
  ) => VanitySystem<VanitySystemTokens<T, P, TokenPolicy, true>, VanitySystemConditionName<C, B>, L[number], Constructors, Axes, VanityPropertyAliasCssFunction<VanitySystemConditionName<C, B>, L[number], Aliases>>
}

export interface VanityStrictAliasedEngineMethods<
  Constructors extends object,
  TokenPolicy extends VanityTokenPolicy,
  Axes extends VanityAxisDefinitions,
  Aliases extends VanityPropertyAliasMap,
> extends VanityEngineCommonMethods<TokenPolicy, Axes> {
  ...
  >(
    options: VanityEngineSystemOptions<T, C, L, P, B, TokenPolicy>,
  ) => VanitySystem<VanitySystemTokens<T, P, TokenPolicy, true>, VanitySystemConditionName<C, B>, L[number], Constructors, Axes, VanityStrictPropertyAliasCssFunction<VanitySystemConditionName<C, B>, L[number], Aliases>>
}
...
export type VanityAliasedEngine<
  Constructors extends object,
  TokenPolicy extends VanityTokenPolicy,
  Axes extends VanityAxisDefinitions,
  Aliases extends VanityPropertyAliasMap,
> = Readonly<Constructors> & VanityAliasedEngineMethods<Constructors, TokenPolicy, Axes, Aliases>

export type VanityStrictAliasedEngine<
  Constructors extends object,
  TokenPolicy extends VanityTokenPolicy,
  Axes extends VanityAxisDefinitions,
  Aliases extends VanityPropertyAliasMap,
> = Readonly<Constructors> & VanityStrictAliasedEngineMethods<Constructors, TokenPolicy, Axes, Aliases>
...
export interface VanityCoreEngine<
  ...
  TokenPolicy extends VanityTokenPolicy = VanityDefaultTokenPolicy,
  Axes extends VanityAxisDefinitions = Record<never, never>,
> extends VanityCanonicalCoreConstructors<DefaultLengthUnit>, VanityEngineMethods<VanityCanonicalCoreConstructors<DefaultLengthUnit>, TokenPolicy, Axes> {}
