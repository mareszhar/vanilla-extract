/**
 * The Vue overlay ([vanity-spec-vue.md]): thin sugar over the core's currencies —
 ...
 * cross-file, rename-safe ([vanity-spec-vue.md §1]). Accepts a thunk returning
 ...
 * into the rendered `style` attribute ([vanity-spec-ports.md §5]).
 */
...
/**
 * The blessed one-liner for anatomy in Vue ([vanity-spec-vue.md §2]): a typed
