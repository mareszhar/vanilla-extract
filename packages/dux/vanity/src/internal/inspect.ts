/**
 * The introspection channel ([vanity-spec-introspection.md]): build-time factories
...
export type VanityEscapeForm = 'css.raw' | 'css.standard' | 'unsafe' | 'globalCss' | 'overrides'
 ...
 * the design system ([vanity-spec-introspection.md §3]): none is a hard gate by
