 ...
 * ([vanity-patterns.md §5]); conditions compose by intersecting arms; every
...
export function compileRule(rule: object, ctx: VanityRuleContext): VanityCompiled {
...
class RuleWalker {
  readonly units = new Map<string, VanityUnit>()
  ...
  private walk(rule: object, arm: VanityArm, path: string[], root: boolean): void {
